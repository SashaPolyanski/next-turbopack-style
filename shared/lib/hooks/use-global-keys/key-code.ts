...
export type KeyCodeList = {
  ...
  /** Tellls the device to perform an instant replay (typically some form of jumping back a shorts amount of time then playing it again; possibly but not usually in slow motion). */
